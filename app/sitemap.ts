...
const STATIC_ROUTES: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/tools/breed-compare`, changeFrequency: "monthly", priority: 0.7 },
  ...
  { url: `${BASE_URL}/tools/vaccine-tracker`, changeFrequency: "monthly", priority: 0.7 },
];
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [...STATIC_ROUTES, ...resourceRoutes];
}
